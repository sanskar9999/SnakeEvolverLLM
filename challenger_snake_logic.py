...
def get_challenger_action(my_snake, opponent_snake, foods, grid_width, grid_height):
    ...
    for action in possible_actions:
        ...
        dist = distance(new_pos, food_pos)
    ...
    if opponent_alive:
        if len(my_snake.positions) > len(opponent_snake.positions):
    ...
    # If no best action found, return a random action from possible actions
